...
RSpec.describe 'conseiller/cooperations/needs' do
  describe "index" do
    ...
    it "displays page without errors" do
      ...
      assign(:charts_names, %w[solicitations_completed solicitations_diagnoses needs_positioning needs_done needs_done_no_help needs_done_not_reachable needs_not_for_me needs_taking_care needs_themes_all needs_subjects_all companies_by_employees companies_by_naf_code])
