module RemindersSpecHelper
  def create_experts_for_reminders
    ...
    let!(:expert_with_many_old_quo_matches) { create :expert_with_users, :with_reminders_register, job: 'expert_with_many_old_quo_matches' }
    ...
    # et avec un stock de plus de 5 besoins non pris en charge
    let!(:expert_with_many_abandoned_matches) { create :expert_with_users, :with_reminders_register, job: 'expert_with_many_abandoned_matches' }
    ...
    # et avec un stock de plus de 5 besoins non pris en charge
    let!(:expert_with_many_quo_matches) { create :expert_with_users, :with_reminders_register, job: 'expert_with_many_quo_matches' }
    ...
    let!(:expert_with_medium_old_quo_matches) { create :expert_with_users, :with_reminders_register, job: 'expert_with_medium_old_quo_matches' }
    ...
    # Expert moins de 2 besoins de plus de 15 jours en attente
    # et avec un stock > 2 < 5 de besoins non pris en charge
    let!(:expert_with_medium_quo_matches) { create :expert_with_users, :with_reminders_register, job: 'expert_with_medium_quo_matches' }
    ...
    let!(:expert_with_one_old_quo_match) { create :expert_with_users, :with_reminders_register, job: 'expert_with_one_old_quo_match' }
    ...
    let!(:expert_with_one_quo_match) { create :expert_with_users, :with_reminders_register, job: 'expert_with_one_quo_match' }
    ...
    let!(:expert_with_one_abandoned_match) { create :expert_with_users, :with_reminders_register, job: 'expert_with_one_abandoned_match' }
