# Counts real SQL queries issued inside a block, ignoring schema/transaction
# statements and cached queries. Used to prove the stats N+1 reduction and
# lock it against regressions.
class QueryCounter
