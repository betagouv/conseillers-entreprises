...
RSpec.describe Annuaire::UsersController do
  ...
  describe 'GET #index' do
    ...
    let!(:user_1) { create :user, :with_expert_relevant_for_skills, :invitation_accepted, antenne: antenne_1 }
    let!(:user_1_same_antenne) { create :user, :with_expert_relevant_for_skills, :invitation_accepted, antenne: antenne_1 }
    let!(:antenne_2) { create :antenne, communes: [commune_est], institution: institution_1 }
    let!(:user_2) { create :user, :with_expert_relevant_for_skills, :invitation_accepted, antenne: antenne_2 }
