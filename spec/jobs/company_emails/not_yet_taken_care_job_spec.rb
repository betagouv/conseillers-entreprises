...
RSpec.describe CompanyEmails::NotYetTakenCareJob do
  ...
  let(:diagnosis_done) { build :diagnosis, solicitation: solicitation_done }
  let(:need_done) { build :need, diagnosis: diagnosis_done }
  ...
  let(:diagnosis_quo_in_time) { build :diagnosis, solicitation: solicitation_quo_in_time }
  let(:need_quo_in_time) { build :need, diagnosis: diagnosis_quo_in_time }
  ...
  let(:diagnosis_quo_not_in_time) { build :diagnosis, solicitation: solicitation_quo_not_in_time }
  let(:need_quo_not_in_time) { build :need, diagnosis: diagnosis_quo_not_in_time }
  ...
  let(:diagnosis_taking_care) { build :diagnosis, solicitation: solicitation_taking_care }
  let(:need_taking_care) { build :need, diagnosis: diagnosis_taking_care }
  ...
  let(:diagnosis_done_no_help) { build :diagnosis, solicitation: solicitation_done_no_help }
  let(:need_done_no_help) { build :need, diagnosis: diagnosis_done_no_help }
  ...
  let(:diagnosis_done_not_reachable) { build :diagnosis, solicitation: solicitation_done_not_reachable }
  let(:need_done_not_reachable) { build :need, diagnosis: diagnosis_done_not_reachable }
  ...
  let(:diagnosis_not_for_me) { build :diagnosis, solicitation: solicitation_not_for_me }
  let(:need_not_for_me) { build :need, diagnosis: diagnosis_not_for_me }
