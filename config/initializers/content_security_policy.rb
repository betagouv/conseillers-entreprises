...
Rails.application.config.content_security_policy do |p|
  ...
  p.img_src     :self, :data, 'https://voxusagers.numerique.gouv.fr', 'https://stats.data.gouv.fr', 'https://www.google.com', 'https://www.google.fr', 'https://googleads.g.doubleclick.net', 'https://www.googletagmanager.com', 'https://www.googleadservices.com', 'https://www.gstatic.com',	'https://adservice.google.com', 'https://www.facebook.com', 'connect.facebook.net'
  p.object_src  :none
  ...
  if Rails.env.development?
    ...
    p.connect_src :self, '*.sentry.io', 'https://api-adresse.data.gouv.fr/', 'https://www.google.com', 'https://adservice.google.com', 'https://pagead2.googlesyndication.com', 'https://tpc.googlesyndication.com', 'https://stats.data.gouv.fr', 'https://www.facebook.com'
