...
Rails.application.config.content_security_policy do |p|
  ...
  p.frame_src :self, 'stats.data.gouv.fr', 'browser.sentry-cdn.com', 'https://cdn.jsdelivr.net/', 'https://bid.g.doubleclick.net', 'https://tube.nocturlab.fr', 'https://www.facebook.com', 'https://tpc.googlesyndication.com', 'https://www.youtube-nocookie.com'
