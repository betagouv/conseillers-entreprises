class Rack::Attack
  ...
  Rack::Attack.blocklist('block bad email') do |req|
    ips = ['137.117.65.40', '20.168.217.16', '172.174.64.146', '13.84.52.121', '20.245.167.249', '138.91.175.192', '172.177.6.16', '40.86.18.81']
    remote_ips = ['172.174.64.0', '13.84.52.0', '20.225.181.0', '20.225.181.119', '20.245.167.0', '138.91.175.0', '172.177.6.0', '40.86.18.0']
