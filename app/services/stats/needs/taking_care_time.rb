module Stats::Needs::TakingCareTime
  ...
  def build_series
    ...
    search_range_by_month.each do |range|
      ...
      tkb_needs = month_query.taken_care_before(number_of_days)
      @taken_care_before.push(tkb_needs.size)
      @taken_care_after.push(month_query.taken_care_after(number_of_days).size)
    end
