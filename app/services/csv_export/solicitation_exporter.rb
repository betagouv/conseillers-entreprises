    ...
    def fields
      {
        ...
        company_forme_exercice: -> { diagnosis&.company&.forme_exercice },
        inscrit_rcs: -> { I18n.t(diagnosis&.company&.inscrit_rcs, scope: [:boolean, :text]) },
        inscrit_rm: -> { I18n.t(diagnosis&.company&.inscrit_rm, scope: [:boolean, :text]) },
        activite_liberale: -> { I18n.t(diagnosis&.company&.activite_liberale, scope: [:boolean, :text]) },
