...
ActiveAdmin.register Antenne do
  ...
  ## Form
  #
  match_filters_attributes = [ :id, :min_years_of_existence, :max_years_of_existence, :effectif_max, :effectif_min, :subjects, :raw_accepted_naf_codes, :raw_accepted_legal_forms, :_destroy ]
