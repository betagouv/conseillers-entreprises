...
class Solicitation < ApplicationRecord
  ...
  def set_siret_and_region
    ...
    if FormatSiret.siret_is_valid(siret_or_siren)
      begin
        company_and_siege = ApiConsumption::CompanyAndSiege.new(siret_or_siren).call
        self.code_region = company_and_siege.siege_facility.code_region
  ...
  GENERIC_EMAILS_TYPES = %i[bad_quality_difficulties bad_quality_investment out_of_region employee_labor_law particular_retirement creation siret moderation]
