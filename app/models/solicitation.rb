...
class Solicitation < ApplicationRecord
  ...
  GENERIC_EMAILS_TYPES = %i[bad_quality_difficulties bad_quality_investment out_of_region employee_labor_law particular_retirement creation siret moderation independent_tva intermediary recruitment_foreign_worker]
