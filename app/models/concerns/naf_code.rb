module NafCode
  ...
  def self.naf_libelle(naf_code, level = 'a10')
    ...
    I18n.t(naf_code, scope: "naf_libelle_#{level}", default: t('naf_libelle.code_not_found'))
  end

  def self.code_a10(naf_code)
    return if naf_code.nil?
    I18n.t(level2_code(naf_code), scope: 'naf_level2_to_naf_a10', default: t('naf_libelle.code_not_found'))
  end
