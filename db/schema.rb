...
ActiveRecord::Schema.define(version: 2022_04_22_085729) do
  ...
  create_table "user_rights", force: :cascade do |t|
    ...
    t.index ["user_id", "antenne_id"], name: "index_user_rights_on_user_id_and_antenne_id", unique: true
