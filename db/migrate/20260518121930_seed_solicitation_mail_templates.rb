  ...
  def up
    templates = [
      ...
      },
      {
        ...
        body_html: <<~HTML.strip
          ...
          <ul>
            ...
            <li><strong>pour les activités artisanales :</strong> <a href="https://www.artisanat.fr/nous-connaitre/contactez-cma">Le portail des Chambers de Métiers et de l'Artisanat en France | Artisanat.fr</a></li>
      ...
      },
      {
        ...
        body_html: <<~HTML.strip
          <p>Vous avez récemment déposé une demande sur le service public <a href="https://conseillers-entreprises.service-public.gouv.fr">conseillers-entreprises.service-public.gouv.fr</a> (ou un site intégrant le service) concernant <b>le recrutement d’un travailleur étranger</b>.</p>
